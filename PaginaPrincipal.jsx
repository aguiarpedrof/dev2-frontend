      ...
      <div className="container mt-3">
        <div className="card text-card">
          <div className="card-body">
            ...
            <p className="card-text">Logo abaixo estarão os campos para você se inscrever na nossa escola de ingles. Você nao irá se arrepender!<br>
            para uma melhor experiencia</br></p>
          </div>
        </div>
